...
public class ContactEditorUI extends javax.swing.JFrame {
 ...
 LinkedList <RecIntegral> LinkedInteg = new LinkedList<>();
    ...
    try {
        ...
        int THREADS = 10; // вариант

    double step = (UpperLimit - LowerLimit) / THREADS;
...
for (int i = 0; i < THREADS; i++) {
    double end = (i == THREADS - 1) ? UpperLimit : start + step;

    threads[i] = new IntegralThread(start, end, Range);
    threads[i].start();

    start = end;
}

// ждем завершения и суммируем
double total = 0;
